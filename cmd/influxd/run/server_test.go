...
`)},
	...
	test.addQueries([]*Query{
		...
		&Query{
			...
			exp:     `{"results":[{"series":[{"name":"cpu","columns":["time","derivative"],"values":[["2010-07-01T18:47:00Z",12.5],["2010-07-01T18:47:02Z",10]]}]}]}`,
		},
		&Query{
			...
			exp:     `{"results":[{"series":[{"name":"cpu","columns":["time","derivative"],"values":[["2010-07-01T18:47:00Z",25],["2010-07-01T18:47:02Z",20]]}]}]}`,
		},
		&Query{
		...
		&Query{
			...
			exp:     `{"results":[{"series":[{"name":"cpu","columns":["time","derivative"],"values":[["2010-07-01T18:47:00Z",50],["2010-07-01T18:47:02Z",40]]}]}]}`,
		},
		&Query{
		...
		&Query{
			...
			exp:     `{"results":[{"series":[{"name":"cpu","columns":["time","derivative"],"values":[["2010-07-01T18:47:00Z",15],["2010-07-01T18:47:02Z",10]]}]}]}`,
		},
		&Query{
			...
			exp:     `{"results":[{"series":[{"name":"cpu","columns":["time","derivative"],"values":[["2010-07-01T18:47:00Z",30],["2010-07-01T18:47:02Z",20]]}]}]}`,
		},
		&Query{
...
`)},
	...
	test.addQueries([]*Query{
		...
		&Query{
			...
			exp:     `{"results":[{"series":[{"name":"cpu","columns":["time","derivative"],"values":[["2010-07-01T18:47:00Z",15],["2010-07-01T18:47:02Z",0]]}]}]}`,
		},
		&Query{
			...
			exp:     `{"results":[{"series":[{"name":"cpu","columns":["time","derivative"],"values":[["2010-07-01T18:47:00Z",30],["2010-07-01T18:47:02Z",0]]}]}]}`,
		},
		&Query{
		...
		&Query{
			...
			exp:     `{"results":[{"series":[{"name":"cpu","columns":["time","derivative"],"values":[["2010-07-01T18:47:00Z",60],["2010-07-01T18:47:02Z",0]]}]}]}`,
		},
		&Query{
		...
		&Query{
			...
			exp:     `{"results":[{"series":[{"name":"cpu","columns":["time","derivative"],"values":[["2010-07-01T18:47:00Z",10],["2010-07-01T18:47:02Z",0]]}]}]}`,
		},
		&Query{
			...
			exp:     `{"results":[{"series":[{"name":"cpu","columns":["time","derivative"],"values":[["2010-07-01T18:47:00Z",20],["2010-07-01T18:47:02Z",0]]}]}]}`,
		},
		&Query{
		...
		&Query{
			...
			exp:     `{"results":[{"series":[{"name":"cpu","columns":["time","derivative"],"values":[["2010-07-01T18:47:00Z",40],["2010-07-01T18:47:02Z",0]]}]}]}`,
		},
		&Query{
